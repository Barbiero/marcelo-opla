...
import jmetal.operators.crossover.CrossoverRelationship;
...
public class PLACrossover implements CrossoverOperator<ArchitectureSolution> {
    ...
    private JavaRandomGenerator getRng() {
        if (rng == null) {
            rng = new JavaRandomGenerator();
        }
        return rng;
    }
    ...
    private <T> T randomObjectFromCollection(Collection<T> collection) {
        ...
        return tmpList.get(rng.nextInt(0, tmpList.size() - 1));
    }
    ...
    /**
     * @see jmetal.operators.crossover.PLACrossover2#addOrCreatePackageIntoOffspring
     */
    ...
    /**
     * @see jmetal.operators.crossover.PLACrossover2#addClassesRealizingFeatureToOffspring
     */
    ...
    /**
     * @see jmetal.operators.crossover.PLACrossover2#addInterfacesRealizingFeatureToOffspring
     */
    ...
    /**
     * @see jmetal.operators.crossover.PLACrossover2#addOperationsRealizingFeatureToOffspring
     */
    ...
    /**
     * @see jmetal.operators.crossover.PLACrossover2#addInterfacesImplementedByClass
     */
    ...
    /**
     * @see jmetal.operators.crossover.PLACrossover2#addInterfacesRequiredByClass
     */
    ...
    /**
     * @see jmetal.operators.crossover.PLACrossover2#addImplementedInterfacesByPackageInOffspring
     */
    ...
    /**
     * @see jmetal.operators.crossover.PLACrossover2#addRequiredInterfacesByPackageInOffspring
     */
    ...
    /**
     * @see jmetal.operators.crossover.PLACrossover2#addInterfacesToPackageInOffSpring
     */
    ...
    /**
     * @see jmetal.operators.crossover.PLACrossover2#addClassesToOffspring
     */
    ...
    /**
     * @see jmetal.operators.crossover.PLACrossover2#addClassToOffspring
     */
     ...
     *
     * @see jmetal.operators.crossover.PLACrossover2#moveHierarchyToSameComponent(Class, Package, Package, Architecture, Architecture, Concern)
     */
    ...
    /**
     * @see jmetal.operators.crossover.PLACrossover2#moveChildrenToSameComponent
     */
    ...
    /**
     * @see jmetal.operators.crossover.PLACrossover2#moveChildrenToDifferentComponent
     */
    ...
    /**
     * @see jmetal.operators.crossover.PLACrossover2#getChildren(Element)
     */
     ...
     * @see jmetal.operators.crossover.PLACrossover2#isValidSolution(Architecture)
     */
    ...
    /**
     * @see jmetal.operators.crossover.PLACrossover2#saveAllRelationshiopForElement
     */
    ...
    /**
     * @see jmetal.operators.crossover.PLACrossover2#obtainChild
     */
    ...
    /**
     * @see jmetal.operators.crossover.PLACrossover2#doCrossover
     */
    ...
    /**
     * @see jmetal.operators.crossover.PLACrossover2#crossoverFeatures
     */
    private ArchitectureSolution[] crossoverFeatures(double probability, ArchitectureSolution parent1, ArchitectureSolution parent2) {
        ...
        if (getRng().nextDouble(0.0, 1.0) < probability) {
            ...
            List<Concern> concerns = offspringArch.getAllConcerns();
            ...
            if (!isArchitectureValid(offspringArch)) {
                offspring[0] = parent1;
                OPLAProblem.discardedSolutions++;
            }
    ...
    public List<ArchitectureSolution> execute(List<ArchitectureSolution> architectureSolutions) {
        ...
        // TODO: remover referencias a esta probabilidade e aplicá-la em um nivel mais alto
