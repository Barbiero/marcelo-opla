        ...
        for (String abordagem : abordagens) {
            for (String software : softwares) {
                for (String algorithm : algoritmos) {
                    ...
                    //System.out.println("");
                    System.out.println("Total de Solu��es em PFComb: " + PFComb.length);
                    System.out.println("Total de Solu��es em PFInc: " + PFInc.length);
                    System.out.println("Total de Solu��es de PFComb em PFInc: " + quantidadeSolucoes);
