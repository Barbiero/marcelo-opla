            ...
            for (String software : softwares) {
                for (String algorithm : algoritmos) {
                    for (String contexto : contextos) {
                        ...
                        //System.out.println("");
                        System.out.println("Total de Solu��es em PFknown: " + PFknown.length);
                        System.out.println("Total de Solu��es em PFtrue: " + PFtrue.length);
                        System.out.println("Total de Solu��es de PFknown em PFtrue: " + quantidadeSolucoes);
